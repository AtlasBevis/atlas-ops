#!/usr/bin/env python3
"""Shared Debezium Avro schemas (Source, heartbeat, signal, schema history)."""

from __future__ import annotations

from typing import Any

from .db import Database, _CONNECTOR_NS, connector_namespace, resolve_database
...
def db_source_schema(db: str) -> dict[str, Any]:
    ...
    key = resolve_database(db)
    ns = _CONNECTOR_NS[key]
    match key:
    ...
    return _source_record(ns, extra)
